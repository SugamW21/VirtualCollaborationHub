...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex items-center justify-center min-h-screen relative overflow-hidden">
        ...
        <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('/images/alog.jpg'); filter: blur(8px);"></div>
        ...
        <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-lg space-y-6 z-10">
            ...
            <p class="text-center text-gray-600">Admin Login page</p>
    
            <!-- Login Form -->
            <form method="POST" action="<?php echo e(route('admin.login'), false); ?>">
                <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','class' => 'block mt-1 w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500','type' => 'password','name' => 'password','required' => true,'autocomplete' => 'current-password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                ...
                <div class="block mt-4">
                    <label for="remember_me" class="inline-flex items-center text-gray-600">
                        ...
                        <span class="ml-2 text-sm"><?php echo e(__('Remember me'), false); ?></span>
                    </label>
                </div>
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a class="text-sm text-indigo-600 hover:text-indigo-500" href="<?php echo e(route('password.request'), false); ?>">
...
<?php endif; ?>
            ...
            <div class="text-center mt-4">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('admin.register'), false); ?>" class="text-indigo-600 hover:text-indigo-500">
...
<?php endif; ?><?php /**PATH C:\laragon\www\VirtualCollaborationHub\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>