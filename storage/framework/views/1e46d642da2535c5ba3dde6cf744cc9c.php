                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="col-span-3 bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/10">
                                ...
                                <div class="mt-4 flex justify-center">
                                    <a href="<?php echo e(route('feedbackandrating'), false); ?>" class="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg text-white font-medium hover:from-purple-600 hover:to-pink-600 transition-all duration-300 transform hover:scale-105">
                                        Leave a Review
                                    </a>
                                </div>
                            </div>
            ...
            function openModal(feature) {
                ...
                modalActionBtn.onclick = function() {
                    const featureLinks = {
                        ...
                        "group-chat": "<?php echo e(route('groupChats'), false); ?>",
