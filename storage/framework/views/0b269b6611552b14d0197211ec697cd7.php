        ...
        methods: {
            connect() {
                this.pusher = new Pusher(this.app.key, {
                    ...
                    disableStats: true,
                    authEndpoint: '<?php echo e(url(request()->path().'/auth'), false); ?>',
                    auth: {
                        headers: {
            ...
            loadChart() {
                $.getJSON('<?php echo e(url(request()->path().'/api'), false); ?>/' + this.app.id + '/statistics', (data) => {
            ...
            subscribeToChannel(channel) {
                this.pusher.subscribe('<?php echo e(\BeyondCode\LaravelWebSockets\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX, false); ?>' + channel)
            ...
            subscribeToStatistics() {
                this.pusher.subscribe('<?php echo e(\BeyondCode\LaravelWebSockets\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX, false); ?>statistics')
            ...
            sendEvent() {
                $.post('<?php echo e(url(request()->path().'/event'), false); ?>', {
...
<?php /**PATH C:\laragon\www\VirtualCollaborationHub\vendor\beyondcode\laravel-websockets\src/../resources/views//dashboard.blade.php ENDPATH**/ ?>