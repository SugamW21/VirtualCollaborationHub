...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex items-center justify-center min-h-screen relative overflow-hidden">
        ...
        <div class="absolute top-4 left-4 z-10">
            <a href="<?php echo e(route('home'), false); ?>" class="px-6 py-3 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500">
                Go Back
            </a>
        </div>
