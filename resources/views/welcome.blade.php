        ...
        <header class="fixed w-full z-50 bg-transparent navbar-blur bg-opacity-10 border-b border-white/10">
            <div class="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="font-semibold text-white/80 hover:text-white transition duration-300 ease-in-out">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="inline-block bg-white/10 hover:bg-white/20 text-white font-semibold px-5 py-2.5 rounded-lg backdrop-blur-sm transition duration-300 ease-in-out border border-white/20">Log in</a>
                        <a href="{{ route('register') }}" class="inline-block bg-gradient-to-r from-primary-600 to-secondary-600 text-white font-semibold px-5 py-2.5 rounded-lg shadow-lg hover:shadow-xl btn-glow transition duration-300 ease-in-out">Register</a>
                    @endif
                </div>
                @endif
            </div>
                ...
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="hero-content text-left space-y-6 animate-fade-in">
                        ...
                        <div class="flex flex-wrap gap-4 pt-4 animate-slide-up animate-delay-400">
                            <a href="{{ route('register') }}" class="inline-block bg-gradient-to-r from-primary-600 to-secondary-600 text-white font-semibold px-8 py-4 rounded-lg shadow-lg hover:shadow-xl btn-glow transition duration-300 ease-in-out">
                                Get Started Free
                            </a>
