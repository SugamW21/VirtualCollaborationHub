...
<head>
    ...
    <style>
        ...
        .hero-bg::before {
            ...
            right: 0;
            bottom: 0;
            background-image: url('images/back.png'); /* Change to your image path */
            background-size: cover;
            background-position: center;
            opacity: 0.2; /* Adjust here for the desired opacity */
...
<body class="antialiased bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-white">
    ...
    <header class="bg-white dark:bg-gray-800 shadow-lg">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                @auth
                    <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-blue-500 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-blue-500 transition">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="inline-block bg-blue-500 text-white font-semibold px-4 py-2 rounded-lg shadow hover:bg-blue-600 transition">Log in</a>
                    <a href="{{ route('register') }}" class="inline-block bg-gray-200 text-gray-600 font-semibold px-4 py-2 rounded-lg shadow ml-4 hover:bg-gray-300 transition dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600">Register</a>
                @endif
            </div>
            @endif
        </div>
